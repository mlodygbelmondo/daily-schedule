    ...
    <div className="taskContainer">
      <div className="taskTopContainer">
        ...
        <div>
          ...
          <button
            className="details-btn btn btn-outline-primary btn-sm"
            onClick={(e) => {
              e.preventDefault()
              e.target.blur()
              handleDetailsShow()
          ...
          <Form>
            <Form.Group className="mb-3">
              ...
              <div className="labelContainer">
                ...
                <button
                  type="button"
                  hidden={isTaskEditable ? "hidden" : null}
                  className="btn btn-light btn-sm edit-notes-activity-btn"
                  onClick={() => {
                    setAllNotEditable()
                    setTaskEditable()
                  }}
              ...
              <Row>
                <Col>
                  ...
                  <div className="labelContainer">
                    ...
                    <button
                      type="button"
                      hidden={isStartTimeEditable ? "hidden" : null}
                ...
                <Col>
                  ...
                  <div className="labelContainer">
                    ...
                    <button
                      type="button"
                      className="btn btn-light btn-sm edit-btn"
                      hidden={isEndTimeEditable ? "hidden" : null}
                      onClick={() => {
                        setAllNotEditable()
                        setEndTimeEditable()
                      }}
                ...
                <Col>
                  ...
                  <div className="labelContainer">
                    ...
                    <button
                      type="button"
                      className="btn btn-light btn-sm edit-clr-btn"
                      onClick={() => {
                        setAllNotEditable()
                        setColorEditable()
                      }}
            ...
            <Form.Group className="mb-3">
              ...
              <div className="labelContainer">
                ...
                <button
                  type="button"
                  hidden={isDetailedEditable ? "hidden" : null}
                  className="btn btn-light btn-sm edit-notes-btn"
                  onClick={() => {
                    setAllNotEditable()
                    setDetailedEditable()
                  }}
      ...
      <Modal show={deleteShow} onHide={handleDeleteClose}>
        ...
        <Modal.Body>
          Do you want to permanently delete this activity?
        </Modal.Body>
        <Modal.Footer>
